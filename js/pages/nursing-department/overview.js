      ...
      <div class="department-responsibility-grid">
        <article class="department-responsibility department-responsibility--primary">
          <figure class="department-responsibility__media">
            <img src="${responsibilities.primary.image.src}" alt="${responsibilities.primary.image.alt}" width="${responsibilities.primary.image.width}" height="${responsibilities.primary.image.height}" loading="lazy">
          </figure>
